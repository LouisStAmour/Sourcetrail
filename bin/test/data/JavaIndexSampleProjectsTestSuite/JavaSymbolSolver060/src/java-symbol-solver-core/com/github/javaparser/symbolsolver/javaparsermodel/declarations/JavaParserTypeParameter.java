...
public class JavaParserTypeParameter
	extends AbstractTypeDeclaration implements TypeParameterDeclaration
{
	...
	@Override public TypeParametrizable getContainer()
	{
		...
		else if (parentNode instanceof com.github.javaparser.ast.body.ConstructorDeclaration)
		{
			...
			Optional<ClassOrInterfaceDeclaration> jpTypeDeclaration =
				jpConstructorDeclaration.getAncestorOfType(
	...
	{
		return wrappedNode.getTypeBound()
			.stream()
	...
	{
		Type type =
			JavaParserFacade.get(typeSolver).convertToUsage(classOrInterfaceType, classOrInterfaceType);
	...
	{
		return "JPTypeParameter(" + wrappedNode.getName() +
			", bounds=" + wrappedNode.getTypeBound() + ")";
	}
