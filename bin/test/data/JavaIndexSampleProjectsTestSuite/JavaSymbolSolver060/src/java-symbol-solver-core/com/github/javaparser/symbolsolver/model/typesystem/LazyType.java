...
public class LazyType implements Type
{
	...
	@Override public int arrayLevel()
	{
	...
	@Override public PrimitiveType asPrimitive()
	{
		return getType().asPrimitive();
	}

	@Override public Wildcard asWildcard()
	{
	...
	@Override public Type replaceTypeVariables(TypeParameterDeclaration tp, Type replaced)
	{
