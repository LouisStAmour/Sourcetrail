...
public class ConstructorResolutionLogic
{
	...
	public static boolean isApplicable(
		ConstructorDeclaration constructor, List<Type> argumentsTypes, TypeSolver typeSolver)
	{
	...
	{
		SymbolReference<ConstructorDeclaration> res = findMostApplicable(
			constructors, argumentsTypes, typeSolver, false);
		if (res.isSolved())
		{
			return res;
		}
	...
	{
		List<ConstructorDeclaration> applicableConstructors =
			constructors.stream()
	...
	private static boolean isMoreSpecific(
		ConstructorDeclaration constructorA, ConstructorDeclaration constructorB, TypeSolver typeSolver)
	{
