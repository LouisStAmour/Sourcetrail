 ...
 */
// TODO Remove references to typeSolver: it is needed to instantiate other instances of
// ReferenceTypeUsage
//      and to get the Object type declaration
public class ReferenceTypeImpl extends ReferenceType
{
	public static ReferenceType undeterminedParameters(
		ReferenceTypeDeclaration typeDeclaration, TypeSolver typeSolver)
	{
	...
	@Override public TypeParameterDeclaration asTypeParameter()
	{
		if (this.typeDeclaration instanceof JavaParserTypeVariableDeclaration)
		{
			JavaParserTypeVariableDeclaration javaParserTypeVariableDeclaration =
				(JavaParserTypeVariableDeclaration)this.typeDeclaration;
	...
	@Override public boolean isAssignableBy(Type other)
	{
		...
		if (other.isPrimitive())
		{
			...
			else
			{
				...
				SymbolReference<ReferenceTypeDeclaration> type = typeSolver.tryToSolveType(
					other.asPrimitive().getBoxTypeQName());
				return type.getCorrespondingDeclaration().canBeAssignedTo(super.typeDeclaration);
			}
		}
		if (other instanceof LambdaArgumentTypePlaceholder)
		{
			return this.getTypeDeclaration().hasAnnotation(
	...
	@Override public Set<MethodUsage> getDeclaredMethods()
	{
