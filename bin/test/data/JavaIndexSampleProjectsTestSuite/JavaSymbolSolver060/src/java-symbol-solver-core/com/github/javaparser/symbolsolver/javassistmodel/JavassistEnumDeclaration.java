...
public class JavassistEnumDeclaration extends AbstractTypeDeclaration implements EnumDeclaration
{
	...
	{
		Optional<FieldDeclaration> field = javassistTypeDeclarationAdapter.getDeclaredFields()
											   .stream()
	...
	{
		return javassistTypeDeclarationAdapter.getDeclaredFields().stream().anyMatch(
