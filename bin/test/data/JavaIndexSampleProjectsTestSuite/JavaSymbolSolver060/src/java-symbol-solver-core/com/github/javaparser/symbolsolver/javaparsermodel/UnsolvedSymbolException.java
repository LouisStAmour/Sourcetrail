 ...
 *
 * @deprecated Use {@link
 *     com.github.javaparser.symbolsolver.model.resolution.UnsolvedSymbolException} instead
 */
// Use the one in model instead
@Deprecated public class UnsolvedSymbolException extends RuntimeException
{
