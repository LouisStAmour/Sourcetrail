...
/**
 * A usage of a type. It could be a primitive type or a reference type (enum, class, interface). In
 * the later case it could take type typeParametersValues (other TypeUsages). It could also be a
 * TypeVariable, like in: <p> class A&lt;Bgt; { } <p> where B is a TypeVariable. It could also be
 * Wildcard Type, possibly with constraints.
 *
...
public interface Type {
	...
	default Type replaceTypeVariables(
		TypeParameterDeclaration tp, Type replaced, Map<TypeParameterDeclaration, Type> inferredTypes)
	{
		return this;
	}

	/**
	 * This is like ({@link #replaceTypeVariables(TypeParameterDeclaration, Type, Map)} but ignores
	 * the inferred values.
	 */
